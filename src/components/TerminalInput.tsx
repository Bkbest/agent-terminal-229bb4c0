  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="flex-1 bg-transparent text-foreground text-sm outline-none placeholder:text-muted-foreground/50 caret-primary disabled:opacity-50 font-mono animate-cursor-blink-caret"
        autoComplete="off"
        spellCheck={false}
      />
    </div>
